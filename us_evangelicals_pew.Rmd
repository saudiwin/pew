...
person_scores %>% sample_n(1500) %>% plot_ly(y=~F2,x=~F1,text=~data_labels) %>% add_markers(hoverinfo='text',name='All Respondents',opacity=0.1) %>% 
  layout(annotations=a,xaxis=list(title='Religious Belief',showticklabels = FALSE),
         yaxis=list(title='Political Opinion',showticklabels = FALSE)) %>% add_lines(data=share_data,y=~ypoints,x=~xpoints,color=~categories,inherit=FALSE,name='shareation',
                                                                                     text=~categories) 
```
...
person_scores %>% sample_n(1500) %>% plot_ly(y=~F2,x=~F1,text=~data_labels) %>% add_markers(hoverinfo='text',name='All Respondents',opacity=0.1) %>% 
  layout(annotations=a,xaxis=list(title='Religious Belief',showticklabels = FALSE),
         yaxis=list(title='Political Opinion',showticklabels = FALSE)) %>% add_lines(data=qi1_data,y=~ypoints,x=~xpoints,color=~categories,inherit=FALSE,name='qi1ation',
                                                                                     text=~categories) 
```
...
person_scores %>% sample_n(1500) %>% plot_ly(y=~F2,x=~F1,text=~data_labels) %>% add_markers(hoverinfo='text',name='All Respondents',opacity=0.1) %>% 
  layout(annotations=a,xaxis=list(title='Religious Belief',showticklabels = FALSE),
         yaxis=list(title='Political Opinion',showticklabels = FALSE)) %>% add_lines(data=attend_data,y=~ypoints,x=~xpoints,color=~categories,inherit=FALSE,name='attendation',
                                                                                     text=~categories) 
```
...
person_scores %>% sample_n(1500) %>% plot_ly(y=~F2,x=~F1,text=~data_labels) %>% add_markers(hoverinfo='text',name='All Respondents',opacity=0.1) %>% 
  layout(annotations=a,xaxis=list(title='Religious Belief',showticklabels = FALSE),
         yaxis=list(title='Political Opinion',showticklabels = FALSE)) %>% add_lines(data=qh1_data,y=~ypoints,x=~xpoints,color=~categories,inherit=FALSE,name='qh1ation',
                                                                                     text=~categories) 
```
...
person_scores %>% sample_n(1500) %>% plot_ly(y=~F2,x=~F1,text=~data_labels) %>% add_markers(hoverinfo='text',name='All Respondents',opacity=0.1) %>% 
  layout(annotations=a,xaxis=list(title='Religious Belief',showticklabels = FALSE),
         yaxis=list(title='Political Opinion',showticklabels = FALSE)) %>% add_lines(data=qb2a_data,y=~ypoints,x=~xpoints,color=~categories,inherit=FALSE,name='qb2aation',
                                                                                     text=~categories) 
```
...
person_scores %>% sample_n(1500) %>% plot_ly(y=~F2,x=~F1,text=~data_labels) %>% add_markers(hoverinfo='text',name='All Respondents',opacity=0.1) %>% 
  layout(annotations=a,xaxis=list(title='Religious Belief',showticklabels = FALSE),
         yaxis=list(title='Political Opinion',showticklabels = FALSE)) %>% add_lines(data=qb2b_data,y=~ypoints,x=~xpoints,color=~categories,inherit=FALSE,name='qb2bation',
                                                                                     text=~categories) 
```